        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_BulidingNumber = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Members", x => x.Id);
                    table.CheckConstraint("EmailCheck", "Email LIKE '%@gmail.com' or Email LIKE '%@yahoo.com' or Email LIKE '%@outlook.com' or Email LIKE '%@hotmail.com'");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCheck1", "Email LIKE '%@gmail.com' or Email LIKE '%@yahoo.com' or Email LIKE '%@outlook.com' or Email LIKE '%@hotmail.com'");
